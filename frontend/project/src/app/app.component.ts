...
export class AppComponent {
  ...
  familyTree: any;
  ngOnInit() {
    let webcallMeIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/></svg>';
    var FamilyTree = require('../assets/libraries/familyTree.js');
    this.initStyle(FamilyTree);
    this.familyTree = new FamilyTree(document.getElementById('tree'), {
      template: 'main',
      mouseScrool: FamilyTree.action.scr,
      roots: [3],
      nodeTreeMenu: true,
    ...
    // nodeContextMenu : {}
      ...
      editForm: {
        ...
        elements: [
            ...
            { type: 'textbox', label: 'Năm sinh', binding: 'bdate' },        
            { type: 'textbox', label: 'Năm mất', binding: 'ddate' },        
        ],
        buttons: {
            edit: {
    ...
    this.familyTree.on('render-link', (sender: any, args: any) => {
    ...
    this.familyTree.on('field', (sender: any, args: any) => {
      if (args.name == 'bdate') {
        if (args.data['ddate']) {
    ...
    this.loadData(data);
    this.familyTree.onInit(() => {
      console.log('init');
    });

    this.familyTree.onUpdateNode((node: any) => {
    ...
    return [
      {
        ...
        pids: [2],
        orderId: 1,
        relationship: 'Great Great mainfather',
        name: 'Jessie England',
      ...
      },
      {
        ...
        pids: [1],
        orderId: 2,
        relationship: 'Great Great mainmother',
        name: 'Quinn West',
...

      {
        ...
        relationship: 'Great Great mainfather',
        name: 'Ray Crook',
        img: 'https://cdn.balkan.app/shared/m60/3.jpg',
        bdate: 1800,
        ddate: 1900,
      },
      {
...

      {
        ...
        fid: 6,
        pids: [14],
        relationship: 'P.mainfather',
        gender: 'male',
        name: 'Ruby Walker',
        img: 'https://cdn.balkan.app/shared/m60/4.jpg',
        bdate: 1950,
      },
      ...
      },
      {
        ...
        relationship: 'Great mainfather',
        name: 'Gill Lyons',
        img: 'https://cdn.balkan.app/shared/m60/5.jpg',
        bdate: 1830,
        ddate: 1930,
      },

      {
        ...
        relationship: 'Great Great mainfather',
        name: 'Lacey Beck',
        img: 'https://cdn.balkan.app/shared/m60/6.jpg',
        bdate: 1800,
        ddate: 1900,
      },
      {
        ...
        relationship: 'Great Great mainmother',
        name: 'Erin Ridley',
        img: 'https://cdn.balkan.app/shared/w60/6.jpg',
        bdate: 1800,
        ddate: 1900,
      },
      {
        ...
        relationship: 'Great mainmother',
        name: 'Emory Wilkins',
        img: 'https://cdn.balkan.app/shared/w60/7.jpg',
        bdate: 1830,
        ddate: 1930,
      },

      {
        ...
        fid: 13,
        pids: [7],
        relationship: 'P.mainmother',
        gender: 'female',
        name: 'Felix Stanley',
        img: 'https://cdn.balkan.app/shared/w60/8.jpg',
      },
      ...
      },
      {
        ...
        relationship: 'Great Great mainmother',
        name: 'Perry Hilton',
        img: 'https://cdn.balkan.app/shared/w60/9.jpg',
        bdate: 1800,
        ddate: 1900,
      },
      {
...

      {
        ...
        gender: 'female',
        name: 'Shelley Moody',
        img: 'https://cdn.balkan.app/shared/w60/4.jpg',
      },
      {
        id: 2007,
        pids: [2001],
      ...
      },
      {
        ...
        gender: 'female',
        name: 'Remi Prince',
        img: 'https://cdn.balkan.app/shared/w30/12.jpg',
      },
      {
        id: 3002,
        fid: 2002,
        mid: 2005,
        tags: ['family_single_male'],
        relationship: 'Child',
        gender: 'male',
        name: 'Storm Dougherty',
      ...
      },
      {
        ...
        gender: 'female',
        name: 'Brittany Nicholls',
        img: 'https://cdn.balkan.app/shared/w30/13.jpg',
      },
      {
        id: 3003,
        fid: 2002,
      ...
      },
      {
        ...
        relationship: 'mainchild',
        gender: 'female',
        name: 'Jamie-Leigh Mcmahon',
      ...
      },
      {
        ...
        gender: 'female',
        name: 'Hareem Hyde',
        img: 'https://cdn.balkan.app/shared/w30/15.jpg',
      },
      {
        id: 4002,
        fid: 3004,
    ...
    FamilyTree.templates.base.defs = `<g transform="matrix(0.05,0,0,0.05,-12,-9)" id="heart">
     ...
     <g transform="matrix(1,0,0,1,0,0)" id="dot"></g>
      ...
      <g style="cursor: pointer;" id="base_tree_menu">
          <circle cx="12.5" cy="12.5" r="14" fill="gray"></circle>
          ${FamilyTree.icon.addUser(16, 16, '#fff', 6, 6)}
      </g>
